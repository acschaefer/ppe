function [parameters, states, chi_squares, n_iterations, time]...
    = cpufit(data, weights, model_id, initial_parameters, tolerance, max_n_iterations, parameters_to_fit, estimator_id, user_info, user_info_size)
...
% check if user_info_size is provided
assert(isempty(user_info) || user_info_size ~= 0, 'The size of user_info not provided!');
